...
**English：** [2026-07-18-match-core-hp-design.md](./2026-07-18-match-core-hp-design.md)

**日期：** 2026-07-18  
**状态：** Implemented (H0–H3) — 2026-07-18；生产默认仍为 `match-core`  
**前置：** [2026-07-17-rust-match-engines-design.zh-CN.md](./2026-07-17-rust-match-engines-design.zh-CN.md)（等价轨）  
**代码根：** 本仓库（`match-rust`）
