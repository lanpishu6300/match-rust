...
**English：** [2026-07-18-pe-optimizations-design.md](./2026-07-18-pe-optimizations-design.md)

**日期：** 2026-07-18  
**状态：** Approved / Implemented (A–C skeleton) — 2026-07-18  
**前置：** [2026-07-18-match-core-hp-design.zh-CN.md](./2026-07-18-match-core-hp-design.zh-CN.md)  
**参考代码：** 外部 `crypto-exchange`（perpetual_exchange 研发）；本仓库（`match-rust`）  
